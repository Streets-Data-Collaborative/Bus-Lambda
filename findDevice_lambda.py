...
def lambda_handler(event, context):
    ...
    try:
        host = "argo-sandbox.c8idj0wb3ddk.us-east-1.rds.amazonaws.com"
        ...
        API_KEY = 'AIzaSyCxwq4vjIeGPeXpWdWoKWhf2AZ_jmfwfJo'
        ...
        return {'bus_Time': str(back_time),'expected_time': time_result, 'device': back_device}
        #return event
